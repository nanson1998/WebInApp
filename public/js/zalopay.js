...
(function (root, factory) {
  ...
  ZaloPay.confirmBinding = function (params, cb) {
    ...
    writeLog(
      "info",
      "ZaloPay.confirmBinding",
      "Received result in function callback"
    );
  ...
  function writeLog() {
    ...
    switch (type) {
      ...
      case "info":
        arg.splice(0, 1);
        arg.length === 1
          ? console.log(formated_time, arg[0])
          : console.log(formated_time, JSON.stringify(arg));
        break;
      default:
        type = "info";
        arg.length === 1
